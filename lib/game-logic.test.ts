...
describe('generateValidPlate', () => {
  const testDictionary = [
    ...
    'aardvark', 'abalone', 'abandon', 'abashed', 'abate', 'abbey',
    // Words starting with B
    'babble', 'babel', 'baboon', 'baby', 'bachelor', 'back',
    'backbone', 'backdrop', 'backer', 'backfire', 'background',
    // Words starting with C
    'cab', 'cabal', 'cabana', 'cabbage', 'cabin', 'cabinet',
    'cable', 'cache', 'cackle', 'cactus', 'cadaver', 'caddie',
