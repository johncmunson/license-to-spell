...
function getRandomColorCombination() {
  return COLOR_COMBINATIONS[
    Math.floor(Math.random() * COLOR_COMBINATIONS.length)
  ]
}
...
export default function Home() {
  ...
  const confettiFireRef = useRef<((opts?: confetti.Options) => void) | null>(
    null,
  )
    ...
    async function loadData() {
      try {
        ...
        if (states.length > 0) {
          ...
          const randomMotto =
            stateMottoList[Math.floor(Math.random() * stateMottoList.length)]
                ...
                <DrawerContent className="font-mono min-w-[310px]">
                  ...
                  <div className="space-y-4 text-sm text-slate-600 px-4 pb-8 text-left max-w-[512px] mx-auto">
                    <div>
                      ...
                      <p>
                        Guess as many words as possible that match the license
                        plate letters before time runs out!
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 mb-1">
                      ...
                      <ul className="list-disc space-y-1 ml-6">
                        ...
                        <li>
                          ...
                          <strong>number of possible words</strong> that can be
                          spelled given the plate letters.
                        </li>
                        <li>
                          You have <strong>5 minutes</strong> per round
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <p>
                        ...
                        <strong>equal to its length</strong>. A 5-letter word =
                        5 points, an 8-letter word = 8 points, etc.
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 mb-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full max-w-lg text-center">
                ...
                {gameState === "playing" && (
                  <button
                    ...
                    data-testid="timer"
                    className={cn(
                      `bg-white rounded-lg shadow-sm border border-slate-200 hover:bg-red-50 transition-colors cursor-pointer group`,
                ...
                >
                  ...
                  <div
                    data-testid="total-possible-points"
                ...
                >
                  ...
                  <div
                    data-testid="average-word-length"
                      ...
                      >
                        {correctGuesses.map((word, index) => (
                          <span
                            ...
                            style={{
                              padding:
                                "clamp(0.125rem, 0.5vw, 0.25rem) clamp(0.5rem, 1.5vw, 0.75rem)",
